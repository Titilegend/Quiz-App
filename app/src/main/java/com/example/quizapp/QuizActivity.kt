...
class QuizActivity : AppCompatActivity() {
    ...
    var answerD = ""
    var correctAnswer = ""
    //to count number of questions in database
    var questionCount = 0
    //the question number
    ...
    //value will bw true when time is running and false otherwise
    ...
    private fun gameLogic(){
        restoreOptions()
        //to set question from database to layout
        databaseReference.addValueEventListener(object:ValueEventListener{
            ...
            if(questionNumber < questions.size){
                ...
                //what should be invisible or visible when questions load
    ...
    //to make the correct answer green
    fun findAnswer(){
        when(correctAnswer){
    ...
    //to prevent user frm clicking more than one option at once
    ...
    //to set colours and options back to default
    fun restoreOptions(){
      ...
      //timer object initialization
        timer = object:CountDownTimer(leftTime,1000,){
            ...
            override fun onFinish() {
               ...
               resetTimer()
                updateCountDownText()
                quizBinding.textViewQuestion.text = R.string.timeUp.toString()
                timerContinue = false
            }
